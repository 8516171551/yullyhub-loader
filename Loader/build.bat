...
g++ -std=c++17 -O2 -static -static-libgcc -static-libstdc++ loader.cpp -o loader.exe -lws2_32 -lbcrypt -lshell32 -lrpcrt4 -lole32 -lwinhttp -lgdi32 -luser32 -lgdiplus -Wl,-Bstatic -lstdc++ -lpthread -lwinpthread
if not !ERRORLEVEL! EQU 0 goto :buildfail
goto :done
